...
class Payment(SQLModel, table=True):
    ...
    id: str = Field(default_factory=lambda: generate_unique_id(), primary_key=True, index=True)
    ...
    external_id: Optional[str] = Field(default=None, index=True)  # Stripe payment_intent_id, etc.
    transaction_id: Optional[str] = Field(default=None, index=True)  # Final transaction ID
